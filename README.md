...
# React v16 - router v4 - demo/test

This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app). It is created to test  react-router-dom (v4).

`This code is based on section 11-routing of ` [this Udemy training](https://www.udemy.com/react-the-complete-guide-incl-redux/learn/v4/overview).
